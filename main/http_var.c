...
//			FW_data.gpio.IN_PORT[1].filtr_time);
	...
	sprintf(buf_temp, " var data=["
			"{U_elem1:\%d\,U_elem2:%d,U_elem3:%d,"
			"U_elem4:%d,U_elem5:%d,U_elem6:%d,U_elem7:%d,"
			"U_elem8:%d,U_elem9:%d,U_elem10:%d,U_elem11:%d,"
			"U_elem12:%d,U_elem13:%d,U_elem14:%d,colors:22},",
			cell_sost.u_mv[0 + sh], cell_sost.u_mv[1 + sh],
			cell_sost.u_mv[2 + sh], cell_sost.u_mv[3 + sh],
			cell_sost.u_mv[4 + sh], cell_sost.u_mv[5 + sh],
			cell_sost.u_mv[6 + sh], cell_sost.u_mv[7 + sh],
			cell_sost.u_mv[8 + sh], cell_sost.u_mv[9 + sh],
			cell_sost.u_mv[10 + sh], cell_sost.u_mv[11 + sh],
			cell_sost.u_mv[12 + sh], cell_sost.u_mv[13 + sh]);
	strcat(buf, buf_temp);

	sh = 14;
	sprintf(buf_temp, "{U_elem1:\%d\,U_elem2:%d,U_elem3:%d,"
			"U_elem4:%d,U_elem5:%d,U_elem6:%d,U_elem7:%d,"
			"U_elem8:%d,U_elem9:%d,U_elem10:%d,U_elem11:%d,"
			"U_elem12:%d,U_elem13:%d,U_elem14:%d,colors:82},",
			cell_sost.u_mv[0 + sh], cell_sost.u_mv[1 + sh],
			cell_sost.u_mv[2 + sh], cell_sost.u_mv[3 + sh],
			cell_sost.u_mv[4 + sh], cell_sost.u_mv[5 + sh],
			cell_sost.u_mv[6 + sh], cell_sost.u_mv[7 + sh],
	...
	sprintf(buf_temp, "{U_elem1:\%d\,U_elem2:%d,U_elem3:%d,"
			"U_elem4:%d,U_elem5:%d,U_elem6:%d,U_elem7:%d,"
			"U_elem8:%d,U_elem9:%d,U_elem10:%d,U_elem11:%d,"
			"U_elem12:%d,U_elem13:%d,U_elem14:%d,colors:88},",
			cell_sost.u_mv[0 + sh], cell_sost.u_mv[1 + sh],
			cell_sost.u_mv[2 + sh], cell_sost.u_mv[3 + sh],
			cell_sost.u_mv[4 + sh], cell_sost.u_mv[5 + sh],
			cell_sost.u_mv[6 + sh], cell_sost.u_mv[7 + sh],
...
//
//	function Timer1(){
//	xhr.open('GET', '/io_get.cgi?add_devname_menu'+ Math.random(), true);
...
//	idTimer1 =setInterval(Timer1,1000);
	...
	sprintf(buf_temp, "let urange1=%d;", cell_sost.u_mv_pole[4]);
	strcat(buf, buf_temp);
	sprintf(buf_temp, "let urange2=%d;", cell_sost.u_mv_pole[5]);
	strcat(buf, buf_temp);
	sprintf(buf_temp, "var urange3=%d;", cell_sost.u_mv_pole[6]);
	strcat(buf, buf_temp);
	sprintf(buf_temp, "var urange4=%d;", cell_sost.u_mv_pole[7]);
	strcat(buf, buf_temp);
...
httpd_handle_t start_webserver(void) {
	...
	if (httpd_start(&server, &config) == ESP_OK) {
		...
		httpd_register_uri_handler(server, &np_html_uri_main_b);
